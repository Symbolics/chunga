...
(defclass chunked-stream (trivial-gray-stream-mixin)
  ((real-stream :initarg :real-stream
                ...
                :documentation "The actual stream that's used for input and/or output."))
  (:documentation "Every chunked stream returned by MAKE-CHUNKED-STREAM is of this type which is a subtype of STREAM."))
...
(defclass chunked-input-stream (chunked-stream fundamental-binary-input-stream)
  ((input-chunking-p :initform nil
   ...
   (input-buffer :initform nil
                 :documentation "A vector containing the binary data from the most recent chunk that was read.")
   ...
   (input-limit :initform 0
                ...
                :documentation "Only the content in INPUT-BUFFER up to INPUT-LIMIT belongs to the current chunk.")
